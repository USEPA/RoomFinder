...
namespace EPA.SharePoint.SysConsole.Extensions
{
    ...
    public static class TenantExtensions
    {
        ...
        /// </summary>
        /// <param name="tenantContext">The tenant context to pull site collections</param>
        ...
        /// </summary>
        /// <param name="adminContext">The Client Context from which External users will be queried</param>
        /// <param name="logger">The Trace Logger for writing logs</param>
