...
namespace EPA.Office365.Graph.Reporting
{
    internal class QueryFilter
    {
        ...
        private const string DefaultServiceEndpointUrl = "https://graph.microsoft.com/{0}/reports/{1}{2}";
        ...
        /// </summary>
        internal ReportUsagePeriodEnum? O365Period { get; set; }
        ...
        internal Uri ToUrl(string graphUrl)
        {
            ...
            {
                parameterset = $"period='{O365Period.Value:f}'";
            }
