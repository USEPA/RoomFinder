...
namespace EPA.Office365.Graph.Reporting.TenantReport
{
     ...
     * */
    internal class SkypeForBusinessOrganizerActivityUserCountsMap : ClassMap<SkypeForBusinessOrganizerActivityUserCounts>
    {
    ...
    /// </summary>
    public class SkypeForBusinessOrganizerActivityUserCounts : JSONODataBase
    {
