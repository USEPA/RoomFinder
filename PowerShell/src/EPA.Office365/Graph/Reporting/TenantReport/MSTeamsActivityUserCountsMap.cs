...
namespace EPA.Office365.Graph.Reporting.TenantReport
{
     ...
     */
    internal class MSTeamsActivityUserCountsMap : ClassMap<MSTeamsActivityUserCounts>
    {
        internal MSTeamsActivityUserCountsMap()
        {
            ...
            Map(m => m.OtherActions).Name("Other Actions").Index(6).Default(0);
            Map(m => m.ReportPeriod).Name("Report Period").Index(7).Default(0);
        }
    }

    /// <summary>
    /// Get the trends on how many unique users participate in Teams.
    /// </summary>
    public class MSTeamsActivityUserCounts : JSONODataBase
    {
