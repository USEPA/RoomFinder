...
namespace EPA.Office365.Graph.Reporting.TenantReport
{
     ...
     * */
    internal class SkypeForBusinessActivityUserDetailMap : ClassMap<SkypeForBusinessActivityUserDetail>
    {
        internal SkypeForBusinessActivityUserDetailMap()
        {
            ...
            Map(m => m.DeletedDate).Name("Deleted Date").Index(3).Default(default(DateTime?));
            ...
            Map(m => m.PeerToPeerLastActivityDate).Name("Peer-to-peer Last Activity Date").Index(8).Default(default(DateTime?));
            Map(m => m.OrganizedConferenceLastActivityDate).Name("Organized Conference Last Activity Date").Index(9).Default(default(DateTime?));
            Map(m => m.ParticipatedConferenceLastActivityDate).Name("Participated Conference Last Activity Date").Index(10).Default(default(DateTime?));
