CREATE TABLE [dbo].[O365ReportSPOTenantStorageMonthly] (
    ...
    [DTADDED]              DATETIME        CONSTRAINT [DF_EPA-O365Report-SPOTenantStorageMonthly_DTADDED] DEFAULT (getdate()) NOT NULL,
    [DTUPD]                DATETIME        NULL,
    CONSTRAINT [PK_EPA-O365Report-SPOTenantStorageMonthly] PRIMARY KEY CLUSTERED ([ID] ASC)
);
