CREATE TABLE [dbo].[O365ReportODFBStorageWeekly] (
    ...
    [DTADDED]              DATETIME        CONSTRAINT [DF_EPA-O365Report-SPOStorageWeeklyListing_DTADDED] DEFAULT (getdate()) NOT NULL,
    [DTUPD]                DATETIME        NULL,
    CONSTRAINT [PK_EPA-O365Report-SPOStorageListing] PRIMARY KEY CLUSTERED ([ID] ASC)
);
