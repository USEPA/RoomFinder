CREATE TABLE [dbo].[O365ReportODFBStorageMonthly] (
    ...
    [DTADDED]              DATETIME        CONSTRAINT [DF_EPA-O365Report-ODFBStorageMonthlyListing_DTADDED] DEFAULT (getdate()) NOT NULL,
    [DTUPD]                DATETIME        NULL,
    CONSTRAINT [PK_EPA-O365Report-ODFBStorageMonthlyListing] PRIMARY KEY CLUSTERED ([ID] ASC)
);
