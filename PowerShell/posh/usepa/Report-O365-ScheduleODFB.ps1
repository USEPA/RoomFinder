[cmdletbinding()]
<#
	Pulls onedrive data and stores it in the database
#>
param(
...
PROCESS {
    ...
    # Run all OneDrive Reporting
    & { invoke-expression (".\epa-console.exe reportusage -r OneDrive -p D90 -l {0}" -f $logFile) }
    & { invoke-expression (".\epa-console.exe reportusage -r OneDrive -details -l {0}" -f $logFile) }
