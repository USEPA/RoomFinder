<#
    SHARP Add-In scanner

        -Connect to Tenant URL
        -Query SHARP Scan Requests list
        -Connect to Test/Prod tenant and Scan individual Add-In Webs or Sites
#>
[CmdletBinding()]
Param(
...
PROCESS {
    ...
    # identify new app requests and create corresponding
    & { invoke-expression (".\epa-console.exe scanEpaAppSchedule --deep-scan --write-files -l {0}" -f $logFile) }
}
END {
