...
PROCESS {
    ...
    # Query sites looking for invalid Site associations
    # What would happen if this runs [does not actually perform updates]
    & { invoke-expression (".\epa-console.exe scanEPASiteGroupAssociation -l {0}" -f $logFile) }
